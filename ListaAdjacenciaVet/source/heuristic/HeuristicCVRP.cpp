...
//
//                solution->insert(baseIda, ListEnd);
////                visited[baseIda->getIdVertice2()] = true;
////                visitedLength++;
//
//                solution->insert(baseVolta, ListEnd);
//                truck->removeCapacity(grafo->getVerticeWeight(baseIda->getIdVertice2()));
//                break;
//            }
//            else
...
//                    solution->insert(newAdjIda, ListEnd);
//                    solution->insert(newAdjIda2, ListEnd);
...
//                    solution->insert(newAdjVolta, ListEnd);
//                    solution->insert(newAdjVolta2, ListEnd);
